  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className='pb-10 bg-white  dark:bg-gray-800'>
        ...
        <nav className='z-20 bg-white flex justify-between sticky top-0 py-6 px-10 dark:bg-gray-800'>
          ...
          <ul className='flex items-center dark:text-white'>
            <li>
              ...
              <button className="mr-6 pt-2 transition duration-300 ease-in-out md:hidden" onClick={() => setNavbar(!navbar)}>
                {navbar ? (
            ...
            <li>
              <BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className='cursor-pointer mt-1' />
            </li>
          </ul>
        </nav>

        {/* mobile */}
        <div className='z-20 sticky top-20'>
          <div className={`flex-1 justify-self-center mt-4 bg-slate-200 rounded-md dark:text-white dark:bg-gray-700 ${navbar ? 'block' : 'hidden'}`}>
        ...
        <section id='homes' className='min-h-screen px-10' >
          {/* profil */}
          <div className='relative mx-auto mt-8 bg-gradient-to-b from-green-400 rounded-full overflow-hidden w-60 h-60 md:mt-20 md:w-80 md:h-80'>
