    ...
    <div className="container flex flex-col justify-center py-16 mx-auto overflow-hidden md:py-20">
      ...
      <div className="my-5">
        <p className="items-baseline mx-5 text-sm italic font-semibold md:text-lg">
          Hello everyone! I am Arya Naufal, a website developer. I am a intermediate experienced and I hope with this I can always learning something new to be able to invent digital applications that can help many people in the future. Could work independently or in a team.
        </p>
      </div>
